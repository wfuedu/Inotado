...
public class ScGradePartDTO extends ScBaseDTO {
	...
	public int hashCode() {
		...
		result = prime * result + gradeScaleId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScGradePartDTO other = (ScGradePartDTO) obj;
		if (gradeId != other.gradeId)
			return false;
		if (gradeScaleId != other.gradeScaleId)
			return false;
